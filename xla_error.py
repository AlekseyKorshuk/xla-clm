...
from transformers import (
    ...
    MODEL_FOR_CAUSAL_LM_MAPPING, AutoModelForCausalLM, TFAutoModelForCausalLM,
    MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING, AutoModelForSeq2SeqLM, TFAutoModelForSeq2SeqLM,
)
...
BATCH_SIZE = 1
PAD_MULTIPLE = 4  # XLA has to retrace for each input length, pads the inputs so as to be multiples of this
